...
exports.extraServiceValidators = void 0;
const async_validator_1 = __importDefault(require("async-validator"));
/* extra services  validators */
const extraServiceValidators = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const descriptor = {
        name: {
            type: "string",
            required: true,
...
exports.extraServiceValidators = extraServiceValidators;
