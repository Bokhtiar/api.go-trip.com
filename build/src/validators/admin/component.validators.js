...
exports.componentValidators = void 0;
const async_validator_1 = __importDefault(require("async-validator"));
/* admin login validators */
const componentValidators = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const descriptor = {
        name: {
            type: "string",
            required: true,
...
exports.componentValidators = componentValidators;
